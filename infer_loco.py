...
def infer(args):
    ...
    if args.students_blocks == 'Both_ViT':
        ...
        students['backward_net'] = FeatureProjectionMLP(in_features=teachers['fe'].embed_dim, out_features=teachers['fe'].embed_dim, pe_dim=pe_dim, reduction_factor=0.4).to(device, dtype=dtype)
        students['forward_net'] = FeatureProjectionMLP(in_features=teachers['fe'].embed_dim, out_features=teachers['fe'].embed_dim, pe_dim=pe_dim, reduction_factor=0.4).to(device, dtype=dtype)
        ...
        students['backward_net'] = FeatureProjectionMLP(in_features=teachers['fe'].embed_dim, out_features=teachers['fe'].embed_dim, pe_dim=pe_dim, act_layer=torch.nn.SiLU, reduction_factor=0.4).to(device=device, dtype=dtype)
        students['forward_net'] = FeatureProjectionMLP(in_features=teachers['fe'].embed_dim, out_features=teachers['fe'].embed_dim, pe_dim=pe_dim, act_layer=torch.nn.SiLU, reduction_factor=0.4).to(device=device, dtype=dtype)
        ...
        students['vit_fw'] = FeatureProjectionMLP(in_features=teachers['vit_fe'].embed_dim, out_features=teachers['vit_fe'].embed_dim, pe_dim=pe_dim, reduction_factor=0.4).to(device=device, dtype=dtype)
        students['vit_bw'] = FeatureProjectionMLP(in_features=teachers['vit_fe'].embed_dim, out_features=teachers['vit_fe'].embed_dim, pe_dim=pe_dim, reduction_factor=0.4).to(device=device, dtype=dtype)
        
        # LLM Students (Standard)
        students['llm_fw'] = FeatureProjectionMLP(in_features=teachers['llm_fe'].embed_dim, out_features=teachers['llm_fe'].embed_dim, pe_dim=pe_dim, act_layer=torch.nn.SiLU, reduction_factor=0.4).to(device=device, dtype=dtype)
        students['llm_bw'] = FeatureProjectionMLP(in_features=teachers['llm_fe'].embed_dim, out_features=teachers['llm_fe'].embed_dim, pe_dim=pe_dim, act_layer=torch.nn.SiLU, reduction_factor=0.4).to(device=device, dtype=dtype)
