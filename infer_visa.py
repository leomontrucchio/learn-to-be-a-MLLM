...
from utils_visa.config_visa import PROMPTS_CONFIG
...
def infer(args):
    ...
    if args.students_blocks == 'Both_ViT':
        ...
        # --- LLM Bidirectional ---
        teachers['fe'] = LLMFeatureExtractor(conversation_template=conv_template, layer1_idx=0, layer2_idx=1).to(device).eval()
        ...
        teachers['llm_fe'] = LLMFeatureExtractor(conversation_template=conv_template, layer1_idx=0, layer2_idx=1).to(device).eval()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--label', default='grounding_new', type=str,
