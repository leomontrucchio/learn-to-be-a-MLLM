...
class HDLLMFeatureExtractor(torch.nn.Module):
    def __init__(self, conversation_template, layers=[0, 1], model_name="deepseek-ai/deepseek-vl2-tiny"):
        super().__init__()
        self.device = "cuda" if torch.cuda.is_available() else "cpu"
    ...
    def forward(self, pil_images):
        ...
        # Process Images and Prepare Batch
        ...
        for i in range(len(pil_images)):
            ...
            # Get Grid Info for this specific image
...
if __name__ == "__main__":
    ...
    extractor = HDLLMFeatureExtractor(conversation_template=conversation_template,layers=layers_to_extract)
