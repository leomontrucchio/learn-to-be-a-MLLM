...
from models.student import FeatureProjectionMLP_FullyTrainable
...
def train(args):
    ...
    students['backward_net'] = FeatureProjectionMLP_FullyTrainable(
        ...
        pe_dim=pe_dim, grid_size=grid_size, act_layer=act_layer, reduction_factor=0.4
    ...
    for epoch in trange(args.epochs_no, desc=f'Training students for {args.class_name}...'):
        ...
        wandb.log({
            ...
            "params/pe_magnitude_fwd": students['forward_net'].trainable_pe.abs().mean().item(),
            "params/pe_magnitude_bwd": students['backward_net'].trainable_pe.abs().mean().item()
        })
